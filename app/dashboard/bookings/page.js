...
import { Calendar, Clock, IndianRupee, MapPin, Search, Filter, Building2, TrendingUp, Star, User } from 'lucide-react'
...
export default function MyBookingsPage() {
  ...
  useEffect(() => {
    filterBookings()
  }, [bookings, searchTerm, paymentStatusFilter, bookingStatusFilter])
  ...
  return (
    <UserLayout user={user} bookingCount={bookings.length}>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
            My Bookings
          </h1>
          <p className="text-gray-600">Track and manage all your venue bookings</p>
        </div>
            ...
            {filteredBookings.length === 0 ? (
              <div className="text-center py-12 bg-white rounded-lg border-2 border-dashed border-gray-300">
                ...
                <p className="text-gray-600 mb-4">
                  {bookings.length === 0 ? 'Start exploring venues and make your first booking!' : 'Try adjusting your filters.'}
                </p>
                {bookings.length === 0 && (
